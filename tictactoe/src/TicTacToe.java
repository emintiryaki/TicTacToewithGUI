...
public class TicTacToe implements ActionListener {
    ...
    JPanel title_panel = new JPanel(); // Başlığın gösterileceği panel...
    JPanel button_panel = new JPanel(); // Butonların tutulacağı panel...
    ...
    public void firstTurn() { // Oyuna ilk kimin başlayacağını belirlemek için yazdık...   
        try
        {
            Thread.sleep(1000);
